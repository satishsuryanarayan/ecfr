...
class CFRInsight:
    ...
    def __repr__(self):
        return f"{self.__class__.__name__}(cfr_reference_id={self.cfr_reference_id}, agency_id={self.agency_id}, parent_agency_id={self.parent_agency_id}, date={self.date}, word_count={self.word_count}, restricted_word_count={self.restrictive_terms_count})"
